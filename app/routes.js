...
// coffee routes ===============================================================
    ...
    app.post('/order', (req, res) => {
      db.collection('order').save({name: req.body.name, msg: req.body.msg, thumbUp: 0, thumbDown:0}, (err, result) => {
        if (err) return console.log(err)
    ...
    app.delete('/order', (req, res) => {
      db.collection('order').findOneAndDelete({name: req.body.name, msg: req.body.msg}, (err, result) => {
...
// =============================================================================
    ...
    // locally --------------------------------
        ...
        app.post('/cashlogin', passport.authenticate('local-login', {
            successRedirect : '/cashprofile', // redirect to the secure profile section
